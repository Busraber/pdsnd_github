...
def get_filters():
    ...
    while month not in ['january', 'february', 'march','april','may','june','july','august','september','october','november','december']:
        month = input(
        "Month is invalid! Please input another month: ").lower()

    # get user input for day of week (all, monday, tuesday,wensday, thursday,friday,saturday sunday)
    day = input("Please input day of week: ").lower()
    
    while day not in ['monday', 'tuesday', 'wednesday','thursday','friday','saturday','sunday']:
        day = input("Day is invalid! Please input another day: ").lower()
